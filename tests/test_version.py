...
def test_version_constant():
    ...
    assert beadstudio.__version__ == "1.1.1"


def test_version_callback_prints_and_exits(capsys):
    """The typer --version callback prints 1.1.1 and raises typer.Exit."""
...
def test_main_version_flag(capsys, monkeypatch):
    """python -m beadstudio --version prints BeadStudio 1.1.1 and returns 0."""
