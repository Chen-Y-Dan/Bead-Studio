...
def _build_palette_lookup(
    ...
    Falls back to ``PERLER_COLORS`` (palette.py, from perler.json) with the
    code itself as name when *palette* is ``None``.
    """
    ...
    # Fill any missing codes from the single-source perler palette
